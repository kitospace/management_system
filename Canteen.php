...
<h2 align="center"><U>NEXTGEN CANTEEN MANAGEMENT SYSTEM</U></h2>
<p align="center">
...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" action="/action_page.php" method="post">
    <div class="imgcontainer">
      ...
      <img src="intern.png" alt="Avatar" class="avatar" >
    </div>

    <div class="container">
      <label for="em_id"><b>Employee ID</b></label>
      <input type="text" placeholder="Enter Employee Id" name="em_id" required>
